...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, sums the likes', () => {
    const result = listHelper.totalLikes(listWithMultipleBlog)
    assert.strictEqual(result, 43)
  })
})

describe('favorite blog based on highest likes', () => {
  test ('when there are multiple top favorites, return one of them', () => {
